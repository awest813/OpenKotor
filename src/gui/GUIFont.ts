...
export class GUIFont {
  ...
  constructor(texture: OdysseyTexture){
    ...
    if(this.texture.txi){
      ...
      this.ratio = (texture.image as HTMLImageElement).width / (texture.image as HTMLImageElement).height;
...
export class GUIFontChar {
  ...
  constructor(font: GUIFont, letter: string){
    ...
    this.width = ((this.lr.x - this.ul.x) * (font.texture.image as HTMLImageElement).width) * this.font.scale;
    this.height = ((this.ul.y - this.lr.y) * (font.texture.image as HTMLImageElement).height) * this.font.scale;
  }
}